            ...
            >
                <Menu.Items className="absolute z-20 top-10 right-2 mt-0.5 w-28 fontSignika origin-top-right rounded-md  shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="">
                        <Menu.Item>
                            <div>
                                <div onClick={handleEdit}  className="text-first bg-second duration-200  cursor-pointer group rounded-t hover:bg-secondHover
                    ...
                    <div className="">
                        <Menu.Item>
                            <div>
                                <div onClick={handleDelete}  className="text-first bg-second duration-200  cursor-pointer group rounded-b hover:bg-secondHover
                                                flex w-full items-center space-x-2 px-4 py-2 text-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
